...
func TestThreadSafeLRU(t *testing.T) {
	...
	l, err := NewThreadSafeWithEvict(128, onEvicted)
	if err != nil {
		t.Fatalf("err: %v", err)
	}
...
func TestLRUAdd(t *testing.T) {
	...
	l, err := NewThreadSafeWithEvict(1, onEvicted)
	if err != nil {
		t.Fatalf("err: %v", err)
	}
...
func TestLRUResize(t *testing.T) {
	...
	l, err := NewThreadSafeWithEvict(2, onEvicted)
	if err != nil {
		t.Fatalf("err: %v", err)
	}
